...
# Gán link tìm kiếm
# source_url = "https://vnexpress.net/khoa-hoc-cong-nghe/ai" #120
# num_pages = 4  # Số trang nguồn 1

# source_url = "https://vnexpress.net/khoa-hoc-cong-nghe/chuyen-doi-so" #40
# num_pages = 2  # Số trang nguồn 2


source_url = "https://vnexpress.net/khoa-hoc-cong-nghe/thiet-bi" #40
num_pages = 2  # Số trang nguồn 3


driver.get(source_url)

# Lấy tên nền tảng nguồn tin
source_name = driver.find_element(By.CSS_SELECTOR, "a.logo").get_attribute("title")
...
for page in range(1, num_pages + 1):
    ...
    # Duyệt qua từng article để lấy tiêu đề
    for article in articles:
        # Lấy link từ tiêu đề — nếu không có link thì bỏ qua hoàn toàn
...
output_file = os.path.join("raw_data", "titles_VN-EP3.json")
