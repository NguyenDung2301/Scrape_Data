...
RAW_DATA_DIR = os.path.join(os.path.dirname(__file__), "raw_data") #folder chứa các file json cần gộp
TITLE_DATA_DIR = os.path.join(os.path.dirname(__file__), "unlabel_title_data") #folder chứa file json đã gộp
OUTPUT_FILE = os.path.join(TITLE_DATA_DIR, "unlabel_merged_titles.json") #tên file json đã gộp
